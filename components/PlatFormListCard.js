...
const PlatFormListCard = ({ imageSrc, showBookingForm, description, ctaText, ctaText2, onClick, onClick2,  title, deliveriesCount, price, currencey, id }) => {
    ...
    return (
        <div
            className="max-w-md rounded relative overflow-hidden shadow-lg py-2"
        ...
        >
              <Link
                    ...
                    className="w-1/2 absolute right-2 top-4"
                >
               
                    <button className="w-full opacity-90 text-white mb-2 sm:mb-0 bg-primary hover:bg-primary-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm  px-1 sm:px-4 py-3 text-center mr-3 md:mr-0 dark:bg-primary w-full dark:hover:bg-primary-800 dark:focus:ring-red-5000">     {ctaText2}</button>
